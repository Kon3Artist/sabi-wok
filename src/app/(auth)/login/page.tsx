      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-md py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors"
          >
